...
var urls =
{
	root:		xjsfl.utils.createURI('templates/root.txt', fl.scriptURI),
	object:		xjsfl.utils.createURI('templates/test/object.txt', fl.scriptURI),
	method:		xjsfl.utils.createURI('templates/test/method.txt', fl.scriptURI),
	getter:		xjsfl.utils.createURI('templates/getter.txt', fl.scriptURI)
}
...
var method = new Template(urls.method)
				.set('name', 'test')
				.set('params', 'str')
				.set('content', '// do alert;', true)
				.set('content', 'alert(str);', true)
				.set('content', new Template(urls.method))
				.set('doc', '/**\n * This is a \n * method\n */');
				
//method.set('content', new Template(urls.object, {name:'Object', content:'// Nothing to see!'}))
method.set('content', new Template(urls.object, {name:'object', content:method})) //.clone().render()

 
// outer template
var object = new Template(urls.root, {name:'Test', content:method});
