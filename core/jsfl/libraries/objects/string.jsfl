...
var methods =
{
	...
	/**
	 * Utility function to trace the current value of the string, then chain it
	 * @param	{String}	value	An optional string to trace
	 */	
	trace:function(value)
	{
		value = value ? value + ': ' : '';
		fl.outputPanel.trace(value + this);
		return this;
	}

}

Utils.extend(String.prototype, methods);
...
var value = 'This is an XML string';
...
var fns =
{
	toCamelCase:function()
	{
		return Utils.toCamelCase(this);
	},
	fromCamelCase:function()
	{
		return Utils.fromCamelCase(this);
	},
	toSentenceCase:function()
	{
		return Utils.toSentenceCase(this);
	},
	toUnderscore:function()
	{
		return Utils.toUnderscore(this);
	},
}


Utils.extend(String.prototype, fns)
