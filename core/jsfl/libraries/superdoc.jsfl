	...
	Superdoc =
	{
		...
		containers:
		{
			...
			scene:
			{
				 ...
				 * @param sceneToMove {Number} An integer that specifies which scene to move, with 0 (zero) being the first scene. 
		...
		data:
		{
			 ...
			 * @param name {String} A string that specifies the name of the data to add.
			 * @param type {String} A string that defines the type of data to add. Acceptable values are "integer", "integerArray", "double", "doubleArray", "string", and "byteArray". 
		...
		elements:
		{
			...
			add:
			{
				 ...
				 * @param position {Object} A point that specifies the x and y coordinates of the location at which to add the item. It uses the center of a symbol or the upper left corner of a bitmap or video. 
				 ...
				 * @param startpoint {Number} A pair of floating-point numbers that specify the x and y coordinates where the line starts. 
				 ...
				 * @param boundingRectangle {Rectangle} A rectangle that specifies the bounds of the oval to be added. For information on the format of boundingRectangle, see document.addNewRectangle(). 
				 * @param bSuppressFill {Boolean} A Boolean value that, if set to true, causes the method to create the shape without a fill. The default value is false. This parameter is optional.
				 ...
				 * @param boundingRectangle {Rectangle} A rectangle that specifies the bounds within which the new oval primitive is added. For information on the format of boundingRectangle, see document.addNewRectangle().
				 * @param bSuppressFill {Boolean} A Boolean value that, if set to true, causes the method to create the oval without a fill. The default value is false. This parameter is optional.
				 ...
				 * @param rect {Rectangle} A rectangle that specifies the bounds within which the new rectangle primitive is added. For information on the format of boundingRectangle, see document.addNewRectangle().
				 * @param roundness {Number}  An integer between 0 and 999 that represents the number of points used to specify how much the corners should be rounded.
				 * @param bSuppressFill {Boolean} A Boolean value that, if set to true, causes the method to create the rectangle without a fill. The default value is false. This parameter is optional.
				 ...
				 * @param boundingRectangle {Text} Specifies the size and location of the text field. For information on the format of boundingRectangle, see document.addNewRectangle().
			...
			filter:
			{
				 ...
				 * @param property {String} A string specifying the property to be set. Acceptable values are "blurX", "blurY", "quality", angle", "distance", "strength", "knockout", "inner", "bevelType", "color", "shadowColor", and "highlightColor".
				 * @param filterIndex {Number} An integer specifying the zero-based index of the filter in the Filters list.
				 ...
				 * @param oldIndex {Number} An integer that represents the current zero-based index position of the filter you want to reposition in the Filters list. 
			...
			text:
			{
				 ...
				 * @param attrName {String} A string that specifies the name of the TextAttrs property to be returned. For a list of property names and expected values, see the Property summary table for the TextAttrs object.
				 * @param startIndex {Number} An integer that specifies the index of first character, with 0 (zero) specifying the first position. This parameter is optional.
				 ...
				 * @param startIndex {Number} An integer that specifies the position of the first character to select. The first character position is 0 (zero).
				 ...
				 * @param startIndex {Number} An integer that is an index of first character to get. This parameter is optional. 
		...
		file:
		{
			...
			imports:
			{
				 ...
				 * @param fileURI {String} A string, expressed as a file:/// URI, that specifies the path of the file to import.
			...
			exports:
			{
				 ...
				 * @param fileURI {String} A string, expressed as a file:/// URI, that specifies the filename for the exported file. If fileURI is an empty string or is not specified, Flash displays the Export Movie dialog box. 
				 * @param bCurrentPNGSettings {Boolean} A Boolean value that specifies whether to use the current PNG publish settings (true) or to display the Export PNG dialog box (false). This parameter is optional. The default value is false.
				 ...
				 * @param fileURI {String} A string, expressed as a file:/// URI, that specifies the name of the exported file. If fileURI is empty or not specified, Flash displays the Export Movie dialog box. This parameter is optional.
		...
		operations:
		{
			...
			mouse:
			{
				 ...
				 * @param position {Number} A pair of floating-point values that specify the x and y coordinates of the click in pixels. 
				 * @param bToggleSel {Boolean} A Boolean value that specifies the state of the Shift key: true for pressed; false for not pressed. 
				 ...
				 * @param position {Number} A pair of floating-point values that specify the x and y coordinates of the click in pixels. 
				 * @param bAltdown {Boolean} A Boolean value that records whether the Alt key is down at the time of the event: true for pressed; false for not pressed. 
				 * @param bShiftDown {Boolean} A Boolean value that records whether the Shift key was down when the event occurred: true for pressed; false for not pressed. 
			...
			tools:
			{
				 ...
				 * @param propertyName {String} A string that specifies the property to be set. For acceptable values, see the Property summary table for the Oval object.
				 ...
				 * @param propertyName {String} A string that specifies the property to be set. For acceptable values, see the Property summary table for the Rectangle object.
				 * @param value {value} The value to be assigned to the property. Acceptable values vary depending on the property you specify in propertyName.
				 * @returns {}
		...
		selection:
		{
			...
			arrange:
			{
				 ...
				 * @param alignmode {String} A string that specifies how to align the selection. Acceptable values are "left", "right", "top", "bottom", "vertical center", and "horizontal center". 
				 ...
				 * @param distributemode {String} A string that specifies where to distribute the selected objects. Acceptable values are "left edge", "horizontal center", "right edge", "top edge", "vertical center", and "bottom edge".
				 ...
				 * @param bWidth {Boolean} A Boolean value that, when set to true, causes the method to make the widths of the selected items the same. 
				 * @param bHeight {Boolean} A Boolean value that, when set to true, causes the method to make the heights of the selected items the same. 
				 ...
				 * @param direction {String} A string that specifies the direction in which to space the objects in the selection. Acceptable values are "horizontal" or "vertical".
			 ...
			 * @param name {String} A string that specifies the name of the persistent data.
			 * @param type {value} Defines the type of data. Acceptable values are "integer", "integerArray", "double", "doubleArray", "string", and "byteArray". 
			 * @param data {value} The value to add. Valid types depend on the type parameter.
			 * @returns {}
			...
			edit:
			{
				 ...
				 * @param type {String} A string that specifies the type of symbol to create. Acceptable values are "movie clip", "button", and "graphic". 
				 * @param name {String} A string that specifies the name for the new symbol, which must be unique. You can submit an empty string to have this method create a unique symbol name for you.
				 ...
				 * @param threshold {Number} An integer that controls the number of colors in your traced bitmap. Acceptable values are integers between 0 and 500. 
				 * @param minimumArea {Number} An integer that specifies the radius measured in pixels. Acceptable values are integers between 1 and 1000. 
				 * @param curveFit {String} A string that specifies how smoothly outlines are drawn. Acceptable values are "pixels", "very tight", "tight", "normal", "smooth", and "very smooth".
			...
			transform:
			{
				 ...
				 * @param boundingRectangle {Rectangle} A rectangle that specifies the new location and size of the selection. For information on the format of boundingRectangle, see document.addNewRectangle().
				 ...
				 * @param xScale {Number} A floating-point value that specifies the amount of x by which to scale. 
				 * @param yScale {Number} A floating-point value that specifies the amount of y by which to scale. 
				 ...
				 * @param xSkew {Number} A floating-point number that specifies the amount of x by which to skew, measured in degrees.
				 * @param ySkew {Number} A floating-point number that specifies the amount of y by which to skew, measured in degrees.
				 ...
				 * @param a {Number} A floating-point number that specifies the (0,0) element of the transformation matrix. 
				 * @param b {Number} A floating-point number that specifies the (0,1) element of the transformation matrix. 
				 * @param c {Number} A floating-point number that specifies the (1,0) element of the transformation matrix. 
			...
			transform3D:
			{
				 ...
				 * @param xyzCoordinate {Object} An XYZ coordinate point that specifies the axes for 3D rotation. 
		...
		shapes:
		{
			outlines:
			{
				 ...
				 * @param smoothing {Number} An integer in the range from 0 to 100, with 0 specifying no smoothing and 100 specifying maximum smoothing. 
